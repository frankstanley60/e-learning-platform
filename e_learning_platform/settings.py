...
SECRET_KEY = 'django-insecure-cvgmiym4ktapkjx032lr=6#nrq)pn42@vcqyd0kz*gq=y!@vt1'
...
MIDDLEWARE = [
    ...
    'django.middleware.locale.LocaleMiddleware',  # Add LocaleMiddleware for language detection
]
